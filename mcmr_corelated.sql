...
SELECT name,salary FROM employee WHERE department='SW' AND salary =(SELECT MAX(salary) FROM employee WHERE department='SW');
SELECT department, MAX(salary) FROM employee   GROUP BY department;
SELECT id,name,salary,department 
FROM employee 
WHERE (department,salary) IN 
(SELECT department, MAX(salary)AS max_salary FROM employee WHERE department IS NOT NULL  GROUP BY department);

SELECT name,age,department 
FROM employee
WHERE (department,age) IN 
(SELECT department, MIN(age)AS youngest FROM employee WHERE department IS NOT NULL  GROUP BY department);


SELECT id,name,salary,department FROM employee e WHERE salary =
(SELECT MAX(salary) FROM 
employee WHERE department =e.department);

SELECT name,age,department FROM employee e WHERE age=
(SELECT MIN(age) FROM employee WHERE department =e.department);

WITH hr_employees AS 
(
SELECT id,name,department FROM employee WHERE department='HR'
)
SELECT department ,COUNT(*) FROM hr_employees 
GROUP BY department;

WITH cte AS
(
SELECT department ,COUNT(*) cnt FROM employee
WHERE department IS NOT NULL
GROUP BY department
)
SELECT department,cnt  FROM cte WHERE 
...
(
SELECT id,name,salary,department 
FROM employee WHERE department='Testing'
)
SELECT id,name,salary FROM hr_employees WHERE 
salary>(SELECT MAX(salary) FROM testing_employees);
